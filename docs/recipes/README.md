Pipeline(s) for taking data from existing databases, sorting through it, and then taking relevent data and adding it to the ontology. Also checks for duplicates and adds additonal axoims needed.
